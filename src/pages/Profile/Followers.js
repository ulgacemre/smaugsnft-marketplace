...
const FollowingItem = ({ data, idx, walletAddress, address, changeFollowingsData, followingsData }) => {
    ...
    return (
        <>
            <div className="follower-list-item d-flex align-center">
                <div className="follower-info d-flex" style={{ alignItems: "center" }}>
...
function Followers({ className, address }) {
    ...
    const changeFollowingsData = (data) => {
    ...
    useEffect(() => {
        if (address) {
            ...
            axios.get(`Users/${address}/follower?filter={"include":  {"relation": "followee","scope": {  "fields":["displayName"], "type": "count" }}}`).then((response) => {
                                ...
                                <>
                                    <div className="col-lg-4 col-xs-12 col-sm-12">
                                        <FollowingItem
                                            ...
                                            changeFollowingsData={changeFollowingsData}
                                            address={address}
                                            data={item}
                                            key={idx}
                                            idx={idx}
